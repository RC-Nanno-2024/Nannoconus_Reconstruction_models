...
def create_haxis_1(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 540, theta_step))
...
def create_haxis_2(theta0,theta_step,R,zstep,rstep, Z):              
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 570, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_3(theta0, theta_step,R,zstep,rstep, Z):
   ...
   r=R 
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 600, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_4(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 630, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_5(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 660, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)               
               if i<=num-5:
...
def create_haxis_6(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 690, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_7(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 720, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_8(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 750, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_9(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 780, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_10(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 810, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_11(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 840, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
def create_haxis_12(theta0,theta_step,R,zstep,rstep, Z):
   ...
   r=R
   vectors=[]
   num_vectors=np.array(np.arange(theta0, 870, theta_step))
   num=np.size(num_vectors)
   for i, th in enumerate(num_vectors):
               thetarad=np.radians(th)
               if i<=num-5:
...
Z=0
vectors1=create_haxis_1(0,36,70,9,5,Z)  # Create first helicoidal axis
vectors2=create_haxis_2(30,36,70,9,5,Z)  # Create second helicoidal axis
vectors3=create_haxis_3(60,36,70,9,5,Z)  # Create second helicoidal axis
vectors4=create_haxis_4(90,36,70,9,5,Z)  # Create second helicoidal axis
vectors5=create_haxis_5(120,36,70,9,5,Z)  # Create first helicoidal axis
vectors6=create_haxis_6(150,36,70,9,5,Z)  # Create second helicoidal axis
vectors7=create_haxis_7(180,36,70,9,5,Z)  # Create second helicoidal axis
vectors8=create_haxis_8(210,36,70,9,5,Z)  # Create second helicoidal axis
vectors9=create_haxis_9(240,36,70,9,5,Z)  # Create second helicoidal axis
vectors10=create_haxis_10(270,36,70,9,5,Z)  # Create first helicoidal axis
vectors11=create_haxis_11(300,36,70,9,5,Z)  # Create second helicoidal axis
vectors12=create_haxis_12(330,36,70,9,5,Z)  # Create second helicoidal axis
...
for i, v in enumerate(vectors1):
         ...
         delta_A=40
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h1, tilt_angle)), delta_A)
...
for i, v in enumerate(vectors2):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h2, tilt_angle)), delta_B)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors3):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h3, tilt_angle)), delta_A)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors4):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h4, tilt_angle)), delta_B)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors5):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h5, tilt_angle)), delta_A)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors6):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h6, tilt_angle)), delta_B)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors7):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h7, tilt_angle)), delta_A)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors8):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h8, tilt_angle)), delta_B)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors9):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h9, tilt_angle)), delta_A)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors10):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h10, tilt_angle)), delta_B)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors11):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h11, tilt_angle)), delta_A)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
...
for i, v in enumerate(vectors12):
         ...
         delta_B=25
         tilt_angle=-35+i*tilt_increment
         flat_2=rotate_lamella_x((rotate_lamella_y(flat_h12, tilt_angle)), delta_B)
         flatr1=np.array(rotate_lamella_z(flat_2, v[0]))+v[1]
         nanno.append(flatr1)
########################################################################
# Create the rectangular array and initialize with zeros
...
np.save('path to save.npy format',rectangular_array)
array = np.load('path to save.npy format')
